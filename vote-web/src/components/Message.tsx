                ...
                >
                  {data.type === "news" && (
                    <img
                      className="w-1/2"
                      src={
                        process.env.REACT_APP_S3_URL + "/images/icons/news.png"
                      }
                      alt="news"
                    />
                  )}
            ...
            <div className="flex flex-col max-w-md lg:w-4/5 h-fit">
              {checkSameNick ? (
                <div className="flex items-center w-fit">
                  ...
                  <div className="m-1 text-sm text-black lg:text-lg">
                    {data.nickname}
                  </div>
                </div>
              ) : null}
              <div className="flex items-end my-[0.1rem] lg:my-[0.3rem] ml-8 lg:ml-12">
                {date && (
                  <div
                    className={`${data.type === "text" ? `border-[#fa95ba]` : `border-[#8f2b50]`} flex flex-col items-center py-1 px-2 lg:px-3 lg:py-2 text-black border-[0.1rem]  rounded-tl-none rounded-2xl break-all w-fit max-w-[60%] lg:max-w-[80%]`}
                  >
                    {data.type === "news" && (
                      <img
                        className="w-1/2"
